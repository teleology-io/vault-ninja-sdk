...
**Install:**
```bash
pip install "https://github.com/teleology-io/vault-ninja-sdk/releases/download/v1.0.1/vault_ninja-1.0.1.tar.gz"
```
...
**Install:**
```bash
npm install "https://github.com/teleology-io/vault-ninja-sdk/releases/download/v1.0.1/teleology-vn-1.0.1.tgz"
```
...
**Install:**
```bash
go get github.com/teleology-io/vault-ninja-sdk/go@v1.0.1
```
